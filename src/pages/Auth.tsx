            ...
            <div className="grid grid-cols-2 gap-3 w-full">
              ...
              <Button variant="outline" disabled={isLoading}>
                <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.5 12.3c0 5.1-3.7 9.6-9 10.5v-7.4h2.5l.5-2.9h-3v-1.9c0-.8.4-1.6 1.7-1.6h1.3V6.7s-1.2-.2-2.3-.2c-2.4 0-3.9 1.4-3.9 4v2.3H8.3v2.9h2v7.4C5.2 21.9 1.5 17.4 1.5 12.3 1.5 6.2 6.4 1.3 12.5 1.3S23.5 6.2 23.5 12.3z"/>
                </svg>
                Microsoft
              </Button>
            </div>
